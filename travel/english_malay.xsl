...
<table width="60%"><tr bgcolor="beige"><td  bgcolor="silver" width="50%"><center><b>English</b></center></td>
<td  bgcolor="lightgreen"><center><b>Malay</b></center></td></tr>


<!-- above <td>s are for the headings.  those below are for the data  -->
<xsl:variable name="ancillary_english"
	select="document('ancillary_english.xml')" />
<xsl:for-each select="document('ancillary_english.xml')/dico/word">


<!--  remove this line if problem  -->
<xsl:sort select="english" data-type="text" />
