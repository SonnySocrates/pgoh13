...
<xsl:template match="/">
<html><head><title>
Spanish-Malay Word List (from "Focus on Malaysia")</title></head><body bgcolor="beige">
<h4><font color="red"><u>Parent site: <a href="http://pgoh13.com"> The World At Your Fingertips</a></u></font></h4>
<h1>Spanish-Malay Word List</h1> 
...
<table width="60%"><tr bgcolor="beige"><td  bgcolor="silver" width="50%"><center><b>Spanish</b></center></td>
<td  bgcolor="lightgreen"><center><b>Malay</b></center></td></tr>


<!-- above <td>s are for the headings.  those below are for the data  -->
<xsl:variable name="ancillary_spanish"
	select="document('ancillary_spanish.xml')" />
<xsl:for-each select="document('ancillary_spanish.xml')/dico/word">


<!--  remove this line if problem  -->
<xsl:sort select="spanish" data-type="text" />
