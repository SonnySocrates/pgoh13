...
<h1>Malay to English Dictionary</h1>

<table><tr><td bgcolor=#cccccc><font face=Arial size=2>
<form name="dico" method="post" action="http://pgoh13.com/malayenglish_dicoanswer.php">

<font face=Arial color=midnightblue size=2><br /><b>Type Malay word in full, that is with the prefix and suffix, if there are any eg. <em>berlanjutan, perlembagaan, memperbaharui</em>.</b></font><input type="text" style=" margin:1px 0; border:1px solid; height:24px; padding:0px 3px; position:relative;" size="20" name="query_malay" value="">
