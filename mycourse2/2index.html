...
<title>Malay 101 course and tutorial (with some Indonesian thrown in for good measure).  Free Basic Malay course by pgoh13. Learn Malay language in 64 lessons.</title>
<meta name="description" content="Malay 101 course and tutorial - with some Indonesian thrown in for good measure.  Free Basic Malay course by pgoh. Learn Malay language in 64 lessons.">
...
<br><a style="font-size:14px;text-decoration:none;font-family:arial;"  href="http://pgoh13.free.fr/mycourse2/actual_time_summer.php" target=_blank><strong style="font-family:arial;color:#006400;">Practise telling the time in Malay for real</strong></a>
<br>
...
<br>
<p style="display:block;background-color:yellow;border:1px solid black;padding:12px;font-family:arial;font-size:18px;font-weight:bold;font-style:normal;max-width:820px;"><font color=red>A Warning:</font>  This course was written quite some time back and as Malay, like all languages, keeps on developing, it is possible that what is written somewhere in this course is no longer true. Just keep this in mind - though a cat will still be <em style="color:red;">kucing</em> in Malay for centuries to come (I believe).  - pgoh13</p>
