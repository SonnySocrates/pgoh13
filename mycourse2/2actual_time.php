...
echo '<em>It is now ' . $heure . ' (' . $jour . ') in India (+4.5 hours France time)</em>';
echo '<br>';
...
echo '<em>It is now ' . $heure . ' (' . $jour . ') in New Zealand (+12 hours France time)</em>';
echo "<br>";
...
echo ' <em>It is now ' . $heure . ' (' . $jour . ') in Hawaii (-11 hours France time)</em>';
echo "<br>";
...
echo ' <em>It is now ' . $heure . ' (' . $jour . ') in New York (-6 hours France time)</em>';
echo "<br>";
...
echo ' <em>It is now ' . $heure . ' (' . $jour . ') in London (-1 hours France time)</em>';
echo "<br>";
...
echo ' <em>It is now ' . $heure . ' (' . $jour . ') in Malaysia (+7 hours France time)</em>';
echo "<br>";
