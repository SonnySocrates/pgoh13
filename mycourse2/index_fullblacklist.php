...
<br />
<h3><span style="background-color:yellow;border:solid black 1px;"><font color=red>&nbsp;&nbsp;Internet's Hall of Shame:  Sites Blacklisted For Plagiarism&nbsp;&nbsp;</font></span></h3>
<table class="boxed" width=750><tr><td>
<FONT face=tahoma color=black size=2>The following sites have plagiarized this Basic Malay Language Course by reproducing it fraudulently in .pdf format without authorization, thus guilty of copyright infringement.  Their URLs will remain in this <span style="background-color:red;color:yellow;border:1px solid black;padding:0 5px;">Hall of Shame</span> until they write in to inform that the document has been removed.
<br />www.blueboard.com/malay/ (Site-owner: Lee, H  of 24 Grammer St, Trenton, NJ 08603, US).  Kurang ajar punya a*s*h*l*.
<br />Note:  The above document has been linked to by a number of other sites offering .pdf documents in internet.
<br />Please note that the lessons that have been reproduced in those sites are hopelessly out of date as all the lessons have been improved since.  Also these <span style="background-color:red;color:yellow;border:1px solid black;padding:0 5px;">unscrupulous educated rogues</span> are not able to reproduce the audio files that you can only find from this site.</font> </td></tr></table>
...
<a href=http://malay.pgoh13.com/lesson34sila.php style="text-decoration:none" class="black">Lesson 34 - Sila (Please - extending an invitation)</a>
