...
<h1><span style="background-color:midnightblue;">&nbsp;test of rss items 1 to 5&nbsp;</span></h1>
...
<font face=Arial color=midnightblue size=2><b>Type item number:</font> &nbsp;&nbsp;</b></font><input type="text" style=" margin:1px 0; border:1px solid; height:24px; padding:0px 3px; position:relative;"
 size="20" name="query_malay" value="">
&nbsp;&nbsp;<input type=submit value="Get English word">
</form>
<?
if ($query_malay){
  $fp = fopen('http://malay.pgoh13.com/test_items.xml','r');
  while(!feof($fp)){
...
<FONT face=tahoma color=black size=3><font color=red><b>How this dictionary is different from other dictionaries:</b></font>
...
<br /><font color=red><b>The hyphen in Malay words:</b></font>
