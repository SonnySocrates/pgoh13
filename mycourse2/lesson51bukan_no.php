...
<H1><span style="background-color:midnightblue;">&nbsp;&nbsp;Lesson 51   <font color="red">  Bukan </font> &nbsp;Not  <font size="4" color="white"> (used with nouns/pronouns)</font></font></span></H1>

<br /><br />
<div class="boxtest">
<b>So you have come this far.  Congratulations!
<br />To continue studying please <a href="javascript:mailto('laposte.net','p.goh')">email me</a> the following information:
<br /><br />
Name:<br />
Email:<br />
Age group: Below 20, 20-30, 30-40, 40-50, etc.<br />
Nationality:<br />
City of residence:<br />
Reason for studying:<br />
How much time daily do you study:<br />
