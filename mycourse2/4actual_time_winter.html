...
<script>
    function afficherDateHeure() {
        ...
        <br>It is now ${nepalHeures}:${nepalMinutes} (${nepalDay}) in Nepal (France +4 3/4 hours).
        <br>Pukul sekarang ${nepalHeures}:${nepalMinutes} di Nepal?
        ...
        <br>Pukul sekarang ${malaysiaHeures}:${malaysiaMinutes} di Malaysia?
        ...
        <br>Pukul sekarang ${londonHeures}:${londonMinutes} di London?
        ...
        <br>Pukul sekarang ${indiaHeures}:${indiaMinutes} di India?
