...
.responsive-table-horizontal tbody td {
    border-left: none;
    border-right: none;
}
@media (max-width: 991px) {
    .responsive-table-responsive, .responsive-table-responsive thead, .responsive-table-responsive thead tr, .responsive-table-responsive thead th, .responsive-table-responsive tbody, .responsive-table-responsive tbody tr, .responsive-table-responsive tbody td {
    ...
    .responsive-table-responsive tbody td {
        border-top: none;
    background-color:gray; 
    }
    .responsive-table-responsive tbody tr:last-child, .responsive-table-responsive tbody td:last-child {
        border-bottom: none;
    }
}
...
<p style="max-width:400px;font-style:italic;font-weight:300;font-size:12px;"><img src=clock_logo1.jpg class="imageflottante" />To avoid any possible misunderstanding in interpreting the time, the 24-hour time is shown here. But in spoken Malay you are expected to use the 12-hour time and say <font color=red>pagi, tengah hari, petang</font> or <font color=red>malam</font> after it depending on whether it is morning, afternoon, evening or night. And, by the way, this is not a running clock. You have to refresh the page to get the latest time!</p>
<br>
