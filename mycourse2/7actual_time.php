...
$today= strftime ("%H:%M",time()+16200);
$daytime= strftime ("%H:%M %A",time()+16200);
echo " <em>It is now (".$daytime.") in India</em>";
echo "<br>";
echo " <font color=red>Pukul berapa sekarang di India?</font>";
echo "<br>";
echo " <font color=red>Sekarang pukul ".$today." di India</font>";
echo "<br><br>";
