...
if ($dinner) {
    echo "Saya makan malam pada pukul $dinner petang, biasanya.<br><br>\n";
}
if ($smoke === 'hisap') {
...
<hr>
<strong style="color:red">A word about the Malay sentences:</strong>
<p style="font-weight:300">To make the presentation less formal and more conversational in tone, I have taken the liberty of adding (if you are less than 25 years old),  "I'm still young" in Malay after your age while if you are in the 45-55 age group I've added "I'm no longer young" (let's face it, eh? you're no longer an adolescent though you might protest and say that age is just a number) and if you are 70 or over "I'm already old" (yes, there's no running away from the fact, unfortunately!)
<br>If a family member is already dead I have added the word <font color=red>malangnya</font> (meaning "unfortunately") to the sentence.
<br>Also when both you and your spouse's age are given I have added younger or older according to the case (or same age as).
<br>And to make sure that there is no possibility of ambiguity (since you are still a student of Malay) I have added what is normally not necessary. Thus:
<br>in the case of a pensioner the Malay sentence is "I don't work anymore, I'm a pensioner";
<br>in the case of an unemployed, "I don't have a job, I'm unemployed";
<br>and in the case of an only child, "I don't have any brothers or sisters, I'm an only child".
<br>I've also added the word <font color=red>biasanya</font> (meaning "usually") in the sentences about your dinner hour and bedtime.
<br>I hope you have no objection to the above additions but if you do, kindly excuse me for it.
<br>Enjoy!
</p>
