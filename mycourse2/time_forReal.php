...
<br>
<h1 style="max-width:600px;">Exercises in telling the time.....</h1>
...
// Check if it's summer time in Auckland (UTC+13) or winter time (UTC+12)
$isSummerTimeAuckland = (date('I', $utcTime + 12 * 3600)); // Auckland DST is opposite of Northern Hemisphere
$aucklandOffset = $isSummerTimeAuckland ? 13 : 12;

// Check if it's summer time in Honolulu (UTC-10, no DST)
$honoluluOffset = -10;

// Calculate the time for Auckland and Honolulu based on UTC
$aucklandTime = $utcTime + ($aucklandOffset * 3600);
$honoluluTime = $utcTime + ($honoluluOffset * 3600);

// Format the time and day for each city
$heureAuckland = strftime("%H:%M", $aucklandTime);
$jourAuckland = strftime("%A", $aucklandTime);

$heureHonolulu = strftime("%H:%M", $honoluluTime);
$jourHonolulu = strftime("%A", $honoluluTime);

// Output the results
echo '<em>It is now ' . $heureAuckland . ' (' . $jourAuckland . ') in Auckland (France +11/+12 hours)</em>';
echo '<br>';
echo '<font color=red>Pukul berapa sekarang di Auckland?</font>';
echo '<br>';
echo '<font color=red>Sekarang pukul ' . $heureAuckland . ' di Auckland</font>';
?>

<br><br>

<?php
echo '<em>It is now ' . $heureHonolulu . ' (' . $jourHonolulu . ') in Honolulu (France -11/-12 hours)</em>';
echo '<br>';
echo '<font color=red>Pukul berapa sekarang di Honolulu?</font>';
echo '<br>';
echo '<font color=red>Sekarang pukul ' . $heureHonolulu . ' di Honolulu</font>';
?>
<br><br>    
...
<p style="max-width:600px;font-size:16px">NOTE: <span style="font-size:smaller;font-style:italic;">By the way the times shown above could be wrong by an hour. Not to worry, just practise saying the time that appears. But if you see that the time is different from that given in the green table and you want to practise saying that the time is incorrect, then say <font color=red>Tidak benar, jam itu tidak betul. Sebenarnya pukul _____  sekarang di ________!</font>
...
<table style="max-width:600px;background-color:#cccccc">
    <tr>
        <td>
...
?>
<br>From the above sentence make the following deductions:
...
<br><a style="text-decoration:none;" href=time_morePractice.php>You want some more? Go here for the day and time in other cities/countries.</a>
<br>
