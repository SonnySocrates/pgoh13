...
<script>
    function afficherDateHeure() {
        ...
        document.getElementById("server-time").textContent =
            `The day, date and time of the various places given here are in relation to the time of my server in France which at the moment is ${jourSemaineEn}, ${jourMois} ${nomMoisEn} ${annee}, ${heuresFrance}:${minutesFrance}.`;
...
<p id="server-time" style="font-size:16px;"></p>
<br>
