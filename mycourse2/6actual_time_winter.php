  ...
  <!-- Javascript below for day and date and time is from Mistral. for day and date add: Hari ini hari ${jourSemaine} ${jourMois} ${nomMois} ${annee}.  -->
   <script>
    function afficherDateHeure() {
        ...
        // Noms des mois en malais (pour référence, bien que non utilisés ici)
        ...
        // Affichage en malais et en anglais
        const dateHeure = `Sekarang pukul ${heures}:${minutes} (hari ${jourSemaineMalais}) di Perancis = It is now ${heures}:${minutes} (${jourSemaineAnglais}) in France`;
...
<p style="max-width:400px;font-style:italic;font-weight:300;font-size:12px;"><img src=clock_logo1.jpg class="imageflottante" />Winter time in France starts on the last Sunday of October each year and lasts for 5 months (until the last Saturday of March) when it's changed to summer time (also called Daylight Saving Time).<br>To avoid any possible misunderstanding in interpreting the time, the 24-hour time is shown here. But in spoken Malay you are expected to use the 12-hour time and say <font color=red>pagi, tengah hari, petang</font> or <font color=red>malam</font> after it depending on whether it is morning, afternoon, evening or night. And, by the way, this is not a running clock. You have to refresh the page to get the latest time!
<br>The day, date and time of the various places given here are in relation to the time of my server in France which at the moment is ${heures}:${minutes} (${jourSemaineAnglais})</p>
<br>
