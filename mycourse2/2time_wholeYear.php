...
const aucklandDay = joursAnglais[aucklandTime.getDay()];
        ...
        <br><a href=https://www.timeanddate.com/worldclock/usa/honolulu>Check time in Honolulu, Hawaii</a>
        <br><br>
...
echo "Yesterday (was) ".$yesterday." in France";
...
echo " = <font color=red>Kelmarin ".$yesterday." di Perancis</font>";
?>
<br>
<?
$tomorrow= strftime ("%A",time()+86400);
echo "Tomorrow (will be) ".$tomorrow." in France";
...
echo " = <font color=red>Esok ".$tomorrow." di Perancis</font>";
?>
</p>
</td></tr></table>
